...
<div class="fc-wrap">
    ...
    <div style="margin-bottom:2rem">
        <div class="d-flex align-items-center gap-3 mb-3">
            <a href="{{ route('admin.fraud.rules.index') }}" style="color:var(--fc-muted); text-decoration:none; font-size:.8rem;">
                ← Back to Rules
            </a>
        </div>
    ...
    <form method="POST" action="{{ isset($fraudRule) ? route('admin.fraud.rules.update', $fraudRule) : route('admin.fraud.rules.store') }}">
        @csrf
            ...
            <div class="fc-card-body">
                <div class="fc-form-grid three">
                    ...
                    <div>
                        ...
                        <select name="condition_operator" id="cond-op" class="fc-control @error('condition_operator') is-invalid @enderror" onchange="updatePreview()">
