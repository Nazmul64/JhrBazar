...
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0">Pixels Edit</h4>
        ...
        <form action="{{ route('admin.pixels.update', $pixel) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    value="{{ old('pixels_id', $pixel->pixels_id) }}"
                    autocomplete="off"
                >
                @error('pixels_id')
            ...
            <div class="mb-4">
                ...
                <div class="form-check form-switch">
                    <input
                        ...
                        {{ old('status', $pixel->status) ? 'checked' : '' }}
                    >
                </div>
            </div>
            ...
            <div class="d-flex gap-2 mb-0">
                ...
                <a href="{{ route('admin.pixels.index') }}" class="btn btn-secondary px-4">Cancel</a>
            </div>
        </form>
    </div>
</div>
