...
<style>
    ...
    .banner-preview-box .placeholder-text {
    ...
    .file-label .req { color:var(--brand); }
...
<form action="{{ route('admin.banner.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-card">
        ...
        <div class="banner-preview-box" id="previewBox">
            <span class="placeholder-text" id="placeholderText">2000 × 500</span>
        ...
        <div class="file-row" style="margin-bottom:22px;">
            <div class="file-label">
                Banner Ratio 4:1 (2000 × 500 px) <span class="req">*</span>
            </div>
        ...
        <div class="own-shop-row">
            ...
            <input type="checkbox" id="for_own_shop" name="for_own_shop"
                   value="1" {{ old('for_own_shop') ? 'checked' : '' }}>
        </div>
