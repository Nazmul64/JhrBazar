...
<aside id="sidebar">
  ...
  <div class="pt-1 pb-3 flex-grow-1">
    ...
    <a class="nav-item-custom active" href="#" data-page="dashboard">
      <i class="bi bi-grid-fill"></i> Dashboard
    </a>
    <a class="nav-item-custom" href="#" data-page="orders">
    ...
    <div class="nav-item-custom has-sub" data-sub="customer">
    ...
    <div class="nav-submenu" id="sub-employee">
      <a class="nav-item-custom" href="#"><i class="bi bi-dot"></i> All Employees</a>
    </div>
    ...
    <a class="nav-item-custom" href="#"><i class="bi bi-truck"></i> Suppliers</a>
