...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1" style="color:#1a1a2e;font-size:22px;">Add Office Expense</h4>
            <p class="text-muted mb-0" style="font-size:13px;">Record a new office operational expense.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-3" style="max-width:680px;">
        <div class="card-body p-4">
            <form action="{{ route('admin.hrm.expense.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-8">
                        <label class="hrm-lbl">Title *</label>
                        <input type="text" name="title" class="form-control hrm-in" value="{{ old('title') }}" required placeholder="e.g. Office Rent - May">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="note" class="form-control hrm-in" rows="2" placeholder="Additional notes...">{{ old('note') }}</textarea>
                    </div>
