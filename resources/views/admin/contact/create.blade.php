            ...
            <form action="{{ route('admin.contact.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @error('contact_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="mt-2" id="contact_image_preview_container" style="display:none;">
                        <img id="contact_image_preview" src="#" alt="Preview" style="max-height: 150px; border-radius: 6px; border: 1px solid #d9d9d9; padding: 4px;">
                    </div>
                </div>
