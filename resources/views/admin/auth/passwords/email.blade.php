...
<head>
  ...
  <title>Admin Forgot Password – Jhr Bazar</title>
...
<div class="login-container">
  ...
  <div class="left-panel">
    ...
    <div class="welcome-text">
      ...
      <p>Reset your admin account credentials securely using your registered email address.</p>
    </div>
    ...
    <div class="feature-list">
      <div class="feature-item">
        ...
        <div class="feature-info">
          ...
          <p>Encrypted reset tokens ensure safety</p>
        </div>
      </div>
      <div class="feature-item">
        <div class="feature-icon"><i class="bi bi-envelope-check-fill"></i></div>
        <div class="feature-info">
          <h6>Instant Notification</h6>
          <p>Quick recovery link sent to your inbox</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="right-panel">
    ...
    @if (session('status'))
      <div class="alert alert-success border-0 shadow-sm mb-4 small" style="border-radius: 12px;">
