                ...
                <div class="row g-0">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" name="salary"
                                       ...
                                       placeholder="Enter basic salary" value="{{ old('salary', $employee->salary) }}">
                                @error('salary')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="father_name"
                                       ...
                                       placeholder="Father's Name" value="{{ old('father_name', $employee->father_name) }}">
                                @error('father_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mother_name"
                                       ...
                                       placeholder="Mother's Name" value="{{ old('mother_name', $employee->mother_name) }}">
                                @error('mother_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="father_nid"
                                       ...
                                       placeholder="Father's NID" value="{{ old('father_nid', $employee->father_nid) }}">
                                @error('father_nid')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mother_nid"
                                       ...
                                       placeholder="Mother's NID" value="{{ old('mother_nid', $employee->mother_nid) }}">
                                @error('mother_nid')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="district"
                                       ...
                                       placeholder="District" value="{{ old('district', $employee->district) }}">
                                @error('district')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="thana"
                                       ...
                                       placeholder="Thana / Police Station" value="{{ old('thana', $employee->thana) }}">
                                @error('thana')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        ...
                        <div class="mb-3">
                            ...
                            @if($employee->father_nid_copy)
                                <div class="mb-2">
                                    <img src="{{ asset($employee->father_nid_copy) }}" alt="Father's NID" style="max-height:80px; border-radius:6px; border:1px solid #ddd;">
                                </div>
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            @if($employee->mother_nid_copy)
                                <div class="mb-2">
                                    <img src="{{ asset($employee->mother_nid_copy) }}" alt="Mother's NID" style="max-height:80px; border-radius:6px; border:1px solid #ddd;">
                                </div>
                            @endif
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const oldDesigId = "{{ old('designation_id', $employee->designation_id) }}";
