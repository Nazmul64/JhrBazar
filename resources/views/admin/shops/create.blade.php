...
.img-preview-placeholder small { font-size: 11px; color: #ccc; }

.profile-img-box { width: 100%; height: 160px; margin-bottom: 10px; }
...
.map-search-dropdown {
    ...
    top: calc(100% + 4px);
    left: 0;
    right: 60px; /* leave room for button */
    background: #fff;
...
<div class="shop-form-wrap">
    ...
    <div class="form-page-title">
        <i class="fas fa-store"></i> Add New Shop
    </div>
    ...
    <form action="{{ route('admin.shops.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section-body">
                <div class="row-img">
                    ...
                    <div>
                        ...
                        <div class="field-wrap" style="margin-bottom:0">
                            <label class="field-label">User profile (Ratio 1:1) <span class="req">*</span></label>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="row-2" style="margin-bottom:12px">
                    ...
                    <div>
                        <div class="img-preview-box banner-img-box" id="bannerPreviewBox">
                            <div class="img-preview-placeholder">
                                <span style="font-size:22px">2000 × 500</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row-2" style="margin-bottom:20px">
                    <div class="field-wrap" style="margin-bottom:0">
                        <label class="field-label">Shop logo (Ratio 1:1) <span class="req">*</span></label>
                    ...
                    <div class="field-wrap" style="margin-bottom:0">
                        <label class="field-label">Shop banner Ratio 4:1 (2000 × 500 px) <span class="req">*</span></label>
...
// ── Leaflet map
var initLat = {{ old('latitude',  23.8103) }};
var initLng = {{ old('longitude', 90.4125) }};

var map    = L.map('shopMap').setView([initLat, initLng], 11);
var marker = null;
...
@if(old('latitude') && old('longitude'))
    ...
    map.setView([{{ old('latitude') }}, {{ old('longitude') }}], 14);
    document.getElementById('coordInfo').innerHTML =
        'Pinned: <span>{{ old("latitude") }}, {{ old("longitude") }}</span>';
@endif
