...
<head>
    ...
    <title>Employee Login | JHR Bazar</title>
...
<body>
    ...
    <div class="login-card">
        <div class="login-header">
            <div class="brand-logo">JHR <span>BAZAR</span></div>
        ...
        <div class="text-center mt-3">
            <a href="{{ route('employee.password.request') }}" class="text-decoration-none" style="font-size: 13px; color: var(--primary); font-weight: 600;">Forgot Password?</a>
        </div>
