{{-- resources/views/auth/seller_passwords/email.blade.php --}}
...
<head>
    ...
    <title>Seller Forgot Password | JHR Bazar</title>
...
<body>
    ...
    <div class="login-card">
        <div class="login-header">
            ...
            <p>Send password recovery link to your seller account email.</p>
        </div>
        ...
        <form action="{{ route('seller.password.email') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="form-control border-start-0" placeholder="seller@company.com" required autofocus>
                </div>
            </div>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('seller.login') }}" class="text-decoration-none" style="font-size: 13px; color: var(--primary); font-weight: 600;"><i class="bi bi-arrow-left me-1"></i> Back to Login</a>
        </div>
    </div>
