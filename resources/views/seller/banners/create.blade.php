...
<style>
    ...
    .preview-img {width:100%;max-width:300px;height:auto;border-radius:var(--r-md);border:1px solid var(--border);display:none;margin-top:12px;}
</style>

<div class="ph">
    <h4 class="ph-title">Add New Banner</h4>
    ...
    <form action="{{ route('seller.banners.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="title" class="form-control" value="{{ old('title') }}" required placeholder="Enter banner title">
                @error('title') <span class="text-danger small">{{ $message }}</span> @enderror
            </div>
            
            <div class="col-md-6 mb-3">
                <label class="form-label">Target Link (Optional)</label>
                <input type="url" name="link" class="form-control" value="{{ old('link') }}" placeholder="https://example.com/promo">
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="file" name="image" class="form-control" accept="image/*" required onchange="previewFile(this)">
            ...
            <div class="col-md-12 mb-4">
                <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" id="statusSwitch" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="cursor:pointer; width: 2.5em; height: 1.2em;">
        ...
        <div class="d-flex gap-3">
            <button type="submit" class="btn-submit"><i class="bi bi-save me-1"></i> Save Banner</button>
        </div>
    </form>
</div>
