...
<div class="container-fluid px-4 py-4">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h4 class="mb-0 fw-bold" style="color:var(--dark);">Edit Voucher</h4>
    </div>
    ...
    <div class="form-card">
        <div class="form-title">
            <i class="bi bi-pencil-square"></i> Edit Voucher
        </div>

        <form action="{{ route('seller.promocode.update', $voucher->id) }}" method="POST">
            @csrf
            @method('POST')
            <div class="row g-4">
                <div class="col-md-6">
                    <label class="form-label">Voucher Code <span class="text-danger">*</span></label>
                    <input type="text" name="voucher_code" class="form-control" placeholder="Voucher Code" value="{{ old('voucher_code', $voucher->voucher_code) }}" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" name="discount" class="form-control" placeholder="Discount" value="{{ old('discount', $voucher->discount) }}" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Minimum Order Amount <span class="text-danger">*</span></label>
                    <input type="number" step="0.01" name="minimum_order_amount" class="form-control" placeholder="Minimum Order Amount" value="{{ old('minimum_order_amount', $voucher->minimum_order_amount) }}" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Limit For Single User</label>
                    <input type="number" name="limit_for_single_user" class="form-control" placeholder="ex: 5" value="{{ old('limit_for_single_user', $voucher->limit_for_single_user) }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Maximum Discount Amount</label>
                    <input type="number" step="0.01" name="maximum_discount_amount" class="form-control" placeholder="ex: 300" value="{{ old('maximum_discount_amount', $voucher->maximum_discount_amount) }}">
                </div>

                <div class="col-md-6">
                    <label class="form-label">Start Date <span class="text-danger">*</span></label>
                    <input type="date" name="start_date" class="form-control" value="{{ old('start_date', $voucher->start_date->format('Y-m-d')) }}" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Start Time <span class="text-danger">*</span></label>
                    <input type="time" name="start_time" class="form-control" value="{{ old('start_time', $voucher->start_time) }}" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Expired Date <span class="text-danger">*</span></label>
                    <input type="date" name="expired_date" class="form-control" value="{{ old('expired_date', $voucher->expired_date->format('Y-m-d')) }}" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Expired Time <span class="text-danger">*</span></label>
                    <input type="time" name="expired_time" class="form-control" value="{{ old('expired_time', $voucher->expired_time) }}" required>
                </div>
            </div>
