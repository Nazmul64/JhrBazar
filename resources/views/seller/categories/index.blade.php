                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td class="py-3">
                                        <div class="bg-light rounded p-1" style="width: 50px; height: 50px;">
                                            @if($category->thumbnail)
                                                <img src="{{ asset($category->thumbnail) }}" alt="" class="img-fluid rounded" style="width: 100%; height: 100%; object-fit: cover;">
                                            @else
                                    ...
                                    <td class="px-4 py-3 text-end">
                                        <div class="form-check form-switch d-inline-block">
                                            <input class="form-check-input" type="checkbox" role="switch" {{ $category->is_active ? 'checked' : '' }} disabled style="cursor: not-allowed; background-color: {{ $category->is_active ? '#f43f5e' : '' }}; border-color: {{ $category->is_active ? '#f43f5e' : '' }}; opacity: 0.8;">
                                        </div>
                                    </td>
                                </tr>
                                @empty
