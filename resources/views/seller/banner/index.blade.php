...
<style>
    ...
    .form-check-input { width:42px !important; height:22px !important; cursor:pointer; border-radius:11px !important; }
    ...
    .b-thumb { width:140px; height:60px; object-fit:cover; border-radius:var(--r-sm); border:1px solid var(--border); }
</style>

<div class="container-fluid px-4 py-4">
    <div class="ph">
        <h4 class="ph-title">Banner Setup</h4>
        <a href="{{ route('seller.banner.create') }}" class="btn-add">
            ...
            <table class="fs-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($banner->image)
                                <img src="{{ asset($banner->image) }}" class="b-thumb" alt="Banner">
                            @endif
                        </td>
                        <td style="font-weight:600;">{{ $banner->title }}</td>
                        <td>
                            <form action="{{ route('seller.banner.toggle', $banner->id) }}" method="POST">
                                @csrf
                        ...
                        <td>
                            <div class="action-wrap">
                                <a href="{{ route('seller.banner.edit', $banner->id) }}" class="btn-act btn-act-edit" title="Edit">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('seller.banner.destroy', $banner->id) }}" method="POST" class="d-inline"
