...
class SellerSupplierController extends Controller
{
    ...
    {
        $query = Supplier::with('user')->where('seller_id', auth()->id())->latest();
    ...
    {
        return view('seller.supplier.create');
    }
    ...
    {
        $supplier = Supplier::where('seller_id', auth()->id())->findOrFail($id);
        $supplier->load('user');
        ...
        return view('seller.supplier.show', compact(
            'supplier',
            'purchases',
            'transactions',
            'monthlyStats',
    ...
    public function edit($id)
    {
        $supplier = Supplier::where('seller_id', auth()->id())->findOrFail($id);
        $supplier->load('user');
        return view('seller.supplier.edit', compact('supplier'));
    }
